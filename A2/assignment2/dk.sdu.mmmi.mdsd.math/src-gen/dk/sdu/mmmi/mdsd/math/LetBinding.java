 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mmmi.mdsd.math.LetBinding#getName <em>Name</em>}</li>
 ...
 * @generated
 */
public interface LetBinding extends Experssion
{
  /**
   ...
   * @see #setName(String)
   * @see dk.sdu.mmmi.mdsd.math.MathPackage#getLetBinding_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link dk.sdu.mmmi.mdsd.math.LetBinding#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
