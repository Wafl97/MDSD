 ...
 * </p>
 * <ul>
 *   <li>{@link dk.sdu.mmmi.mdsd.ex.setLang.impl.TupleImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TupleImpl extends ExpressionImpl implements Tuple
{
  ...
  {
    return SetLangPackage.Literals.TUPLE;
  }
  ...
  public EList<Expression> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<Expression>(Expression.class, this, SetLangPackage.TUPLE__VALUES);
    }
    return values;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SetLangPackage.TUPLE__VALUES:
